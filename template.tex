...
This allowed us to optimize the initial loading speed of the page - since it only has to render one treemap on load, instead
ten, the page shows up much faster.

\subsection{Issues Encountered}
**colorblindness
**issues with DB on ONID
**colors on initial year 2007
